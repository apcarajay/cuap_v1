	    ...
	    if(ext && accept.indexOf(ext) == -1){
        	...
        	//alert(myFile);
			  ...
			  reader.onload = function(event) {
			    ...
			    var iSize = Math.round(($("#inputfile")[0].files[0].size / 1024));
			    var mb = Math.round(iSize / 1024);
			    

			    if(mb > 30){
			    	alert("File size is " + Math.round(iSize / 1024) + " MB. It exceeds the limit of 30 MB! ");
